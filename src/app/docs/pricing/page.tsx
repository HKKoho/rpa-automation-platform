  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-yellow-50 border-2 border-yellow-400 shadow-lg rounded-lg p-6 mb-12">
          ...
          <div className="bg-blue-50 shadow-lg rounded-lg overflow-x-auto border-2 border-blue-200">
            <table className="w-full text-sm">
              ...
              <tbody className="text-gray-700">
                <tr className="border-b border-gray-300">
                  <td className="p-4 font-semibold text-blue-600">Monthly Cost (USD)</td>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 shadow-lg rounded-lg p-6 border-2 border-blue-200">
              ...
              <p className="text-gray-700 text-sm mb-4">Small credit union processing ACH transactions</p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-blue-600">Time Saved:</span>
                  <span className="text-gray-800">3.5 hours/day</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">Labor Savings:</span>
                  <span className="text-green-600 font-semibold">$2,520/month</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">Platform Cost:</span>
                  <span className="text-gray-800">$105/month</span>
                </div>
                <div className="border-t border-gray-300 pt-2 flex justify-between">
                  <span className="text-gray-700 font-semibold">Net Savings:</span>
                  <span className="text-green-600 font-bold">$2,415/month</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">Annual ROI:</span>
                  <span className="text-green-600 font-bold">28,700%</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 shadow-lg rounded-lg p-6 border-2 border-blue-200">
              ...
              <p className="text-gray-700 text-sm mb-4">National bank processing multiple clearinghouses</p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-blue-600">Time Saved:</span>
                  <span className="text-gray-800">190 hours/week</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">Total Savings:</span>
                  <span className="text-green-600 font-semibold">$99,667/month</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">Platform Cost:</span>
                  <span className="text-gray-800">$12,950/month</span>
                </div>
                <div className="border-t border-gray-300 pt-2 flex justify-between">
                  <span className="text-gray-700 font-semibold">Net Savings:</span>
                  <span className="text-green-600 font-bold">$86,717/month</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-600">Annual ROI:</span>
                  <span className="text-green-600 font-bold">670%</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <a href="/docs/setup" className="bg-blue-50 shadow-lg rounded-lg p-6 border-2 border-blue-200 hover:border-blue-400 transition-colors">
              ...
              <p className="text-gray-700 text-sm">BigQuery & Power BI integration</p>
            </a>
